#ifndef GIFTRANSCODER_H
#define GIFTRANSCODER_H
...
class GifTranscoder : public TranscoderInterface
{
public:
    GifTranscoder();
    ~GifTranscoder();
...
private:
    ...
    AVFilterContext *m_paletteSourceContext; // filter input to provide a frame's palette
    AVFrame *m_paletteFrame; // colour palette for better colour reduction when encoding gifs
